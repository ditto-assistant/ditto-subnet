...
CREATE TABLE public.coding_sealed_evidence_finalizations (
    ...
    CONSTRAINT ck_coding_sealed_evidence_finalizations_coding_sealed_e_8fc9 CHECK ((((claim_generation >= 1) AND (claim_generation <= 2147483647)) AND (sha256 ~ '^[0-9a-f]{64}$'::text) AND (weight_eligible = false)))
);


--
-- Name: coding_sealed_evidence_uploads; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.coding_sealed_evidence_uploads (
    upload_id uuid NOT NULL,
    ticket_id uuid NOT NULL,
    claim_generation integer NOT NULL,
    evidence_kind text NOT NULL,
    ...
    CONSTRAINT ck_coding_sealed_evidence_uploads_coding_sealed_evidenc_6b72 CHECK ((((claim_generation >= 1) AND (claim_generation <= 2147483647)) AND (sha256 ~ '^[0-9a-f]{64}$'::text) AND (content_type = 'application/octet-stream'::text) AND (weight_eligible = false))),
    CONSTRAINT ck_coding_sealed_evidence_uploads_coding_sealed_evidenc_b686 CHECK ((((evidence_kind = 'authoring-transcript'::text) AND ((size_bytes >= 1) AND (size_bytes <= 536870912))) OR ((evidence_kind = 'frozen-submission'::text) AND ((size_bytes >= 1) AND (size_bytes <= 134217728))) OR ((evidence_kind = ANY (ARRAY['authoring-publication-request'::text, 'terminal-publication-request'::text])) AND ((size_bytes >= 1) AND (size_bytes <= 4194304))) OR ((evidence_kind = ANY (ARRAY['authoring-publication-acknowledgement'::text, 'terminal-publication-acknowledgement'::text])) AND ((size_bytes >= 1) AND (size_bytes <= 1048576)))))
);
...
ALTER TABLE ONLY public.coding_sealed_evidence_finalizations
    ADD CONSTRAINT coding_sealed_evidence_finalizations_pkey PRIMARY KEY (upload_id);


--
-- Name: coding_sealed_evidence_uploads coding_sealed_evidence_uploads_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coding_sealed_evidence_uploads
    ADD CONSTRAINT coding_sealed_evidence_uploads_pkey PRIMARY KEY (upload_id);


--
-- Name: coding_sealed_evidence_uploads coding_sealed_evidence_uploads_ticket_generation_kind_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coding_sealed_evidence_uploads
    ADD CONSTRAINT coding_sealed_evidence_uploads_ticket_generation_kind_key UNIQUE (ticket_id, claim_generation, evidence_kind);


--
-- Name: coding_sealed_evidence_uploads coding_sealed_evidence_uploads_upload_authority_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coding_sealed_evidence_uploads
    ADD CONSTRAINT coding_sealed_evidence_uploads_upload_authority_key UNIQUE (upload_id, ticket_id, claim_generation, evidence_kind, sha256, size_bytes);
...
--
-- Name: coding_sealed_evidence_finalizations_ticket_finalized_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX coding_sealed_evidence_finalizations_ticket_finalized_idx ON public.coding_sealed_evidence_finalizations USING btree (ticket_id, finalized_at);


--
-- Name: coding_sealed_evidence_uploads_ticket_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX coding_sealed_evidence_uploads_ticket_created_idx ON public.coding_sealed_evidence_uploads USING btree (ticket_id, created_at);
...
--
-- Name: coding_sealed_evidence_uploads coding_sealed_evidence_uploads_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER coding_sealed_evidence_uploads_append_only BEFORE DELETE OR UPDATE ON public.coding_sealed_evidence_uploads FOR EACH ROW EXECUTE FUNCTION public.guard_coding_catalog_append_only();
...
--
-- Name: coding_sealed_evidence_finalizations coding_sealed_evidence_finalizations_upload_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coding_sealed_evidence_finalizations
    ADD CONSTRAINT coding_sealed_evidence_finalizations_upload_fkey FOREIGN KEY (upload_id, ticket_id, claim_generation, evidence_kind, sha256, size_bytes) REFERENCES public.coding_sealed_evidence_uploads(upload_id, ticket_id, claim_generation, evidence_kind, sha256, size_bytes) ON DELETE CASCADE;


--
-- Name: coding_sealed_evidence_uploads coding_sealed_evidence_uploads_ticket_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coding_sealed_evidence_uploads
    ADD CONSTRAINT coding_sealed_evidence_uploads_ticket_fkey FOREIGN KEY (ticket_id) REFERENCES public.coding_shadow_tickets(ticket_id) ON DELETE CASCADE;
