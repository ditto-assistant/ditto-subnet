...
func TestValidateRejectsUnsupportedEvidenceVersions(t *testing.T) {
	tests := []struct {
		...
		{name: "future bench", mutate: func(e *Evidence) { e.BenchVersion = BenchVersionV13 + 1 }},
	}
...
func TestApplyForVersionContracts(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "future version rejected", version: BenchVersionV13 + 1, evidence: &passingV10, is: ErrUnsupportedVersion},
	}
