...
Repair correctness requires authoritative authoring freeze and pristine grading
evidence. Candidate-integrity zeros may be proven from authoring evidence
alone when the miner-attributable abuse is already bound, without requiring a
successful grader path. Pre-authoritative transport, unavailable private
objects, and grader/control-plane failures are classified as trusted
infrastructure. Missing or malformed candidate evidence fails closed and cannot
