locals {
  ...
  machine_type_map = {
    ...
    # Same burst class on the N2D (AMD EPYC) family. It provides faster cargo
    # builds than e2 at a small price premium; kept as its own logical size so
    # e2 consumers don't move.
