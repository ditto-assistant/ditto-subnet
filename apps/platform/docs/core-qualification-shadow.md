...
This PR does not issue a coding task. A separate reviewed PR must add a shadow
coding job/score ledger, and coding contract v2 plus calibration and owner
approval remain prerequisites for any emissions allocation.
