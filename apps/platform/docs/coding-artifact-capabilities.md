...
requested TTL or ticket deadline. Path-style and virtual-hosted S3 addressing
are validated as coupled host/path pairs, and V4 signing time plus duration must
