  ...
  return (
    <footer>
      <div class="foot-links" aria-label="Open-source Ditto repositories">
        ...
        <a
          href="https://github.com/ditto-assistant/ditto-subnet/tree/main/services/screener"
          target="_blank"
          rel="noopener"
        >
          Screening worker ↗
        ...
        <a
          href="https://github.com/ditto-assistant/ditto-subnet/tree/main/miners/starter-kit"
          target="_blank"
          rel="noopener"
        >
          Miner starter kit ↗
