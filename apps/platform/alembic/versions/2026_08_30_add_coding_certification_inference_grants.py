"""add claimed-lease shadow coding certification inference grants

Revision ID: d4e9a1c7b258
Revises: c1f8d4a0b367
Create Date: 2026-08-30

Public-canary inference grants bind a claimed certification lease. They never
require a private coding ticket or a prior certified receipt.
"""
...
revision: str = "d4e9a1c7b258"
down_revision: str | Sequence[str] | None = "c1f8d4a0b367"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "grant_id",
            name="coding_certification_inference_grants_pkey",
        ),
        sa.UniqueConstraint(
            "lease_id",
...
def downgrade() -> None:
    op.drop_index(
        "coding_certification_inference_grants_validator_expiry_idx",
        table_name="coding_certification_inference_grants",
    )
    op.drop_table("coding_certification_inference_grants")
