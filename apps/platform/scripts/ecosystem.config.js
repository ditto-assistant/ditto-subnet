...
const relayApp = (port, index) => ({
  ...
  env: {
    ...
    DITTO_CODING_HIPPIUS_EVIDENCE_ENABLED: "false",
    ...
    DITTO_CODING_HIPPIUS_TIMEOUT_SECONDS: "",
    ...
    // The one-shot canary environment is rendered to a separate protected file
    // and is never part of ordinary PM2 startup. Clear it anyway so a manual
    // operator shell cannot accidentally forward reader authority to a relay.
    DITTO_CODING_HIPPIUS_CANARY_ENABLED: "false",
