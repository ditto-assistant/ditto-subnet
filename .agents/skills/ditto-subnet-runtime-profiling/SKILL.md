...
3. Identify the smallest repeated unit of work. Prefer removing, caching,
   batching, or narrowing it before rewriting a broad subsystem.
...
5. Add parity tests and state the activation boundary. After deployment, capture
   the same profile again; local benchmarks and CI do not prove the live win.
