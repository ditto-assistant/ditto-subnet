# LongMem shadow rollout record — 2026-09-12 → 2026-09-14
...
| — | `1a2555cf` (retest gen 2 of `bf9f5bfe`) | aceron_v16 | — | — | pending, unissued (cap spent by canary 3); needs an explicitly authorized window |
