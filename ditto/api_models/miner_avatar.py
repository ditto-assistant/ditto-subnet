...
These models are a byte-identical copy of the Platform
``ditto/api_models/miner_avatar.py`` module, which is the source of
truth; any change there must land here too.
"""
