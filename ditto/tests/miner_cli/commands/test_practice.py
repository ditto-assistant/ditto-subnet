"""Tests for the one-command local Bench v9 practice wrapper."""
...
def test_rehearsal_argv_defaults_to_v9_runner_contract() -> None:
...
@pytest.mark.parametrize(
    ("argv", "expected"),
    [
        (["practice"], {"run_size": "small", "longmem_eval": False}),
        (
