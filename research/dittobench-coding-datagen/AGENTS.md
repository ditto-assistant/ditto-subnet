...
uv run mypy src
uv run pytest -q
uv run dittobench-coding-datagen verify-public-v2-release --archive practice/v2/coding-public-v2-2026-09-04-r2.tar.gz --descriptor practice/v2/coding-public-v2-2026-09-04-r2.release.json
```
